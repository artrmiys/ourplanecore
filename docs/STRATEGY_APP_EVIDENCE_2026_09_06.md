...
| **P03a, защита данных** | **Интегрированный source PASS** | [DataFileReader](../Models/Storage/DataFileReader.cs), [DataSafetyTests](../Tests/DataSafetyTests.cs), [WPF smoke](../Tests/DataSafetyUiSmokeHarness.cs). Общий набор 2.2.7: **798/798 C#**; Python **29/29**. | Повторная проверка готового EXE, реальная защита повреждённых данных и bulk-операции фиксируются в `../../bench/native-227-westminster-all/data-safety.json` и финальном QA. |
...
Проверки текущей интеграции: `../../integration-227-full-tests.log` — 798/798; `../../integration-227-python-tests.log` — 29/29; `../../integration-227-scroll-build.log` — 0 warnings / 0 errors.
