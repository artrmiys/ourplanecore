...
public static class ModuleFeatureCatalog
{
    private static readonly ReadOnlyCollection<ModuleFeatureDefinition> Definitions =
        Array.AsReadOnly(new[]
        {
            ...
            new ModuleFeatureDefinition(ModuleId.SheetManager, "Documents", "Sheet Manager", "Manage sheet names, metadata, scale, raster, and page properties.", false),
            new ModuleFeatureDefinition(ModuleId.TakeoffManager, "Takeoff", "Takeoff Manager", "Manage takeoff folders, items, sections, and properties.", false),
            ...
            new ModuleFeatureDefinition(ModuleId.ReportBuilder, "Output", "Report Builder", "Build structured reports from job and takeoff data.", false),
            new ModuleFeatureDefinition(ModuleId.Materials, "Output", "Materials", "Material extraction and material output workflows.", false),
            new ModuleFeatureDefinition(ModuleId.Ai, "Assistance", "AI", "AI Inbox, assisted takeoff actions, markers, and review workflows.", false),
            new ModuleFeatureDefinition(ModuleId.ThreeD, "Assistance", "3D", "3D model, massing, roof, wall, and framing workflows.", false),
